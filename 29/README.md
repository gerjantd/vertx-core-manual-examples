...
CDI access to vertx extension of Wildfly Microprofile Reactive Messaging Kafka quickstart (deploying webapp on Wildfly with Vert.x and Microprofile Reactive Messaging enabled).
...
Shell 2:
```
./5-term2-enable-fp-mp-reactive.sh
